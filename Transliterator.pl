...
## OP 29 DECEMBER ский_кий > skий_kий (zo min mogelijk nu al translitereren; ging fout bij Выучейский)
	$name =~ s/(sky|skii|skyi|skiy)($|[-\/_ ])/skий$2/gi
	  ; ## Mikhailovsky_Mikhailovskii (niet: Mikhailovski_maar die gaat toch al redelijk goed)
	$name =~ s/(ky|kii|kyi|kiy)($|[-\/_ ])/kий$2/gi;         ## Blizky
	$name =~ s/(khy|khii|khyi|khiy)($|[-\/_ ])/khий$2/gi;    ## Vetkhy

## De y en de i: wel of geen й?
	$name =~ s/([aeiou])(y|i)([bvgdzklmnprstfch])/$1й$3/gi
	  ;    ## Maydan_Maidan_Mikhail_Novorossiisk/Novorossiysk
	$name =~ s/([bvgdzklmnprstfch])(ia)(^$|[^-\/_ ])/$1я$3/gi
	  ; ## Viazemsky (maar niet: Akademia; voor gevallen als Daria wordt later gecorrigeerd)
	$name =~ s/([bvgdzklmnprstfch])(iu)(^$|[^-\/_ ])/$1ю$3/gi;    ## Liudmila

## TOEGEVOEGD OP 22 DECEMBER
	$name =~ s/(Zv)я(d)/$1ia$2/gi
	  ;   ## Zvяd > Zviad (handmatige uitzondering op bovengenoemde vervanging)
	$name =~ s/(D)я(n)/$1ia$2/gi
	  ;    ## Dяn > Dian (handmatige uitzondering op bovengenoemde vervanging)
	$name =~ s/(p)ю(s)/$1iu$2/gi
	  ; ## (Gip)pюs > (Gip)pius (handmatige uitzondering op bovengenoemde vervanging)
...
## AANGESCHERPT OP 29 DECEMBER
	$name =~ s/([A-Z_-z])ye($|[-\/_ ])/$1ые$2/gi
	  ;    ## Novye_..._maar wel A.Ye. Yegorov > A.Je. Jegorov
...
###Volgende bevatten nog sporen van Javascriptcode van Pepijn en kunnen dus anders dan bedoeld werken!! Let op de komma in de letterklassen. Negeert '^' vooraan de klasse elk element ervan?
	...
	$name =~
	  s/(^|[ -_\/])(Алена)([^А-Я,а-я]|$|[ -_\/,.])/$1Алёна$3/gi;
	$name =~ s/(^|[ -_\/])(Артем)([^и,ь]|$|[ -_\/,.])/$1Артём$3/gi;
	$name =~
s/(^|[ -_\/])(Матрена)([^А-Я,а-я]|$|[ -_\/,.])/$1Матрёна$3/gi;
	$name =~
	  s/(^|[ -_\/])(Петр)([^А-Я,а-я]|$|[ -_\/,.])/$1Пётр$3/gi;
	$name =~
s/(^|[ -_\/])(Парфен)([^А-Я,а-я]|$|[ -_\/,.])/$1Парфён$3/gi;
	$name =~
	  s/(^|[ -_\/])(Фекла)([^А-Я,а-я]|$|[ -_\/,.])/$1Фёкла$3/gi;
	$name =~
	  s/(^|[ -_\/])(Флена)([^А-Я,а-я]|$|[ -_\/,.])/$1Флёна$3/gi;
	$name =~
	  s/(^|[ -_\/])(Семен)([^А-Я,а-я]|$|[ -_\/,.])/$1Семён$3/gi;
	$name =~ s/(^|[ -_\/])(Федор)/$1Фёдор/gi;
	$name =~
s/(^|[ -_\/])(Соловьев)([А-Я,а-я]|$|[ -_\/,.])/$1Соловьёв$3/gi;
	$name =~
s/(^|[ -_\/])(Семенов)([А-Я,а-я]|$|[ -_\/,.])/$1Семёнов$3/gi;
	$name =~
s/(^|[ -_\/])(Воробьев)([А-Я,а-я]|$|[ -_\/,.])/$1Воробьёв$3/gi;
	$name =~
s/(^|[ -_\/])(Федоров)([А-Я,а-я]|$|[ -_\/,.])/$1Фёдоров$3/gi;
	$name =~
s/(^|[ -_\/])(Киселев)([А-Я,а-я]|$|[ -_\/,.])/$1Киселёв$3/gi;
	$name =~
s/(^|[ -_\/])(Ковалев)([А-Я,а-я]|$|[ -_\/,.])/$1Ковалёв$3/gi;
	$name =~
s/(^|[ -_\/])(Королев)([А-Я,а-я]|$|[ -_\/,.])/$1Королёв$3/gi;
	$name =~
s/(^|[ -_\/])(Пономарев)([А-Я,а-я]|$|[ -_\/,.])/$1Пономарёв$3/gi;
	$name =~
s/(^|[ -_\/])(Журавлев)([А-Я,а-я]|$|[ -_\/,.])/$1Журавлёв$3/gi;
	$name =~
s/(^|[ -_\/])(Аксенов)([А-Я,а-я]|$|[ -_\/,.],)/$1Аксёнов$3/gi;
	$name =~
s/(^|[ -_\/])(Селезнев)([А-Я,а-я]|$|[ -_\/,.])/$1Селезнёв$3/gi;
	$name =~
s/(^|[ -_\/])(Горбачев)([А-Я,а-я]|$|[ -_\/,.])/$1Горбачёв$3/gi;
	$name =~
s/(^|[ -_\/])(Муравьев)([А-Я,а-я]|$|[ -_\/,.])/$1Муравьёв$3/gi;
	$name =~
s/(^|[ -_\/])(Бобылев)([А-Я,а-я]|$|[ -_\/,.])/$1Бобылёв$3/gi;
	$name =~
s/(^|[ -_\/])(Белозеров)([А-Я,а-я]|$|[ -_\/,.])/$1Белозёров$3/gi;
	$name =~
s/(^|[ -_\/])(Лихачев)([А-Я,а-я]|$|[ -_\/,.])/$1Лихачёв$3/gi;
	$name =~
s/(^|[ -_\/])(Фомичев)([А-Я,а-я]|$|[ -_\/,.])/$1Фомичёв$3/gi;
	$name =~
s/(^|[ -_\/])(Пискарев)([А-Я,а-я]|$|[ -_\/,.])/$1Пискарёв$3/gi;
	$name =~
s/(^|[ -_\/])(Слепнев)([А-Я,а-я]|$|[ -_\/,.])/$1Слепнёв$3/gi;
	$name =~
s/(^|[ -_\/])(Хрущев)([А-Я,а-я]|$|[ -_\/,.])/$1Хрущёв$3/gi;
	$name =~
s/(^|[ -_\/])(Еременко)([А-Я,а-я]|$|[ -_\/,.])/$1Ерёменко$3/gi;
	$name =~
s/(^|[ -_\/])(Пугачев)([А-Я,а-я]|$|[ -_\/,.])/$1Пугачёв$3/gi;
	...
	$name =~
	  s/(Артемчик)([^А-Я,а-я]|$|[ -_\/,.])/Артёмчик$2/gi;
	...
	$name =~
s/(Звездочка)([^А-Я,а-я]|$|[ -_\/,.])/Звёздочка$2/gi;
	...
	$name =~
	  s/(Матренка)([^А-Я,а-я]|$|[ -_\/,.])/Матрёнка$2/gi;
...
s/(Селиверстка)([^А-Я,а-я]|$|[ -_\/,.])/Селивёрстка$2/gi;
	...
	$name =~
s/(Сильверстка)([^А-Я,а-я]|$|[ -_\/,.])/Сильвёрстка$2/gi;
	...
	$name =~
	  s/(Феклушка)([^А-Я,а-я]|$|[ -_\/,.])/Фёклушка$2/gi;
	$name =~ s/(Фефелка)([^А-Я,а-я]|$|[ -_\/,.])/Фефёлка$2/gi;
	$name =~ s/(Фленка)([^А-Я,а-я]|$|[ -_\/,.])/Флёнка$2/gi;
	$name =~
	  s/(Христена)([^А-Я,а-я]|$|[ -_\/,.])/Христёна$2/gi;
	$name =~
	  s/(Христеня)([^А-Я,а-я]|$|[ -_\/,.])/Христёня$2/gi;
...
#push @output, $generator->addOutput('populair', '<span class="na_field">Invalid Input: Please do not mix Latin and Cyrillic scripts in the input.</span>');
		push @output,
		  $generator->addOutput( 'populair',
'<span class="na_field">Ongeldige Input: Gelieve de Latijnse en Cyrillische scripts niet te mengen in de input.</span>'
		  );
	}
	else {
...
#$in2 =~ s/(^|[ -_\/])Е(вген|вграф|вдок|влам|влог|вмен|все|вст|втих|вфим|гор|лизар|лисе|лист|ллиди|мель|пифан|реме|рми|рмол|роф|фим|фрем)/$1Э$2/gi;
			$in2 =~
s/^Е(вген|вграф|вдок|влам|влог|вмен|все|вст|втих|вфим|гор|лизар|лисе|лист|ллиди|мель|пифан|реме|рми|рмол|роф|фим|фрем)/ЙЕ$1/gi;
			$in2 =~
s/([ -_\/])Е(вген|вграф|вдок|влам|влог|вмен|все|вст|втих|вфим|гор|лизар|лисе|лист|ллиди|мель|пифан|реме|рми|рмол|роф|фим|фрем)/$1ЙЕ$2/gi;
			## vrouwennamen
#$in2 =~ s/(^|[ -_\/])Е(ва|вангел|влали|вламп|впрак|встол|вфроси|катер|лен|лизавет|ликони|пистим|фросин)/$1Э$2/gi;
			$in2 =~
s/^Е(ва|вангел|влали|вламп|впрак|встол|вфроси|катер|лен|лизавет|ликони|пистим|фросин)/ЙЕ$1/gi;
			$in2 =~
s/([ -_\/])Е(ва|вангел|влали|вламп|впрак|встол|вфроси|катер|лен|лизавет|ликони|пистим|фросин)/$1ЙЕ$2/gi;
...
#	engels_cyrillisch_uitvoer = engels_cyrillisch_uitvoer.replace(/(^|[ -\/])(ближн|верхн|весенн|вечерн|внешн|внутренн|горн|давн|далн|долн|древн|задн|зимн|искренн|крайн|летн|#лишн|нижн|осенн|передн|поздн|последн|прежн|ранн|син|сосдедн|средн|сторонн|утренн)(ы|ый|ии)($|[ -\/,.])/gi, "$1$2ий$4");
			...
			$in2 =~
s/([ -_\/])(ближн|верхн|весенн|вечерн|внешн|внутренн|горн|давн|далн|долн|древн|задн|зимн|искренн|крайн|летн|лишн|нижн|осенн|передн|поздн|последн|прежн|ранн|син|сосдедн|средн|сторонн|утренн)(ы|ый|ии)($|[ -_\/,.])/$1$2ий$4/gi;
			$in2 =~
s/([ -_\/])(ближн|верхн|весенн|вечерн|внешн|внутренн|горн|давн|далн|долн|древн|задн|зимн|искренн|крайн|летн|лишн|нижн|осенн|передн|поздн|последн|прежн|ранн|син|сосдедн|средн|сторонн|утренн)(а)/$1$2я/gi;

			$in2 =~
			  s/([бвгдзжйклмнпрстфхцчшщ])ы(ев)/$1ь$2/gi
			  ;    ##????? Dot het niet? Cf. fouten Ndls Advies
			$in2 =~
s/([бвгдзжйклмнпрстфхцчшщ])ы(и[чн])/$1ь$2/gi;
...
s/(^|[ -_\/])(Пугачев)([А-Я,а-я]|$|[ -_\/,.])/$1Пугачёв$3/gi;
			$in2 =~
s/(Аксенка)([^А-Я,а-я]|$|[ -_\/,.])/Аксёнка$2/gi;
			...
			$in2 =~
			  s/(Аленка)([^А-Я,а-я]|$|[ -_\/,.])/Алёнка$2/gi;
			$in2 =~
			  s/(Артема)([^А-Я,а-я]|$|[ -_\/,.])/Артёма$2/gi;
			$in2 =~
s/(Артемка)([^А-Я,а-я]|$|[ -_\/,.])/Артёмка$2/gi;
			$in2 =~
s/(Артемчик)([^А-Я,а-я]|$|[ -_\/,.])/Артёмчик$2/gi;
			$in2 =~
			  s/(Артеша)([^А-Я,а-я]|$|[ -_\/,.])/Артёша$2/gi;
			$in2 =~
			  s/(Валена)([^А-Я,а-я]|$|[ -_\/,.])/Валёна$2/gi;
			$in2 =~
			  s/(Васена)([^А-Я,а-я]|$|[ -_\/,.])/Васёна$2/gi;
			$in2 =~
			  s/(Васеня)([^А-Я,а-я]|$|[ -_\/,.])/Васёня$2/gi;
			$in2 =~
s/(Василек)([^А-Я,а-я]|$|[ -_\/,.])/Василёк$2/gi;
			$in2 =~
			  s/(Витеша)([^А-Я,а-я]|$|[ -_\/,.])/Витёша$2/gi;
			$in2 =~ s/(Галек)([^А-Я,а-я]|$|[ -_\/,.])/Галёк$2/gi;
			$in2 =~
			  s/(Галека)([^А-Я,а-я]|$|[ -_\/,.])/Галёка$2/gi;
			$in2 =~ s/(Данек)([^А-Я,а-я]|$|[ -_\/,.])/Данёк$2/gi;
			$in2 =~
			  s/(Дарена)([^А-Я,а-я]|$|[ -_\/,.])/Дарёна$2/gi;
			$in2 =~
			  s/(Дареха)([^А-Я,а-я]|$|[ -_\/,.])/Дарёха$2/gi;
			$in2 =~
			  s/(Дареша)([^А-Я,а-я]|$|[ -_\/,.])/Дарёша$2/gi;
...
s/(Звездочка)([^А-Я,а-я]|$|[ -_\/,.])/Звёздочка$2/gi;
			$in2 =~
			  s/(Игорек)([^А-Я,а-я]|$|[ -_\/,.])/Игорёк$2/gi;
			$in2 =~
			  s/(Катена)([^А-Я,а-я]|$|[ -_\/,.])/Катёна$2/gi;
			...
			$in2 =~
			  s/(Кузена)([^А-Я,а-я]|$|[ -_\/,.])/Кузёна$2/gi;
...
s/(Матренка)([^А-Я,а-я]|$|[ -_\/,.])/Матрёнка$2/gi;
			$in2 =~
s/(Матреха)([^А-Я,а-я]|$|[ -_\/,.])/Матрёха$2/gi;
			$in2 =~
s/(Матреша)([^А-Я,а-я]|$|[ -_\/,.])/Матрёша$2/gi;
			$in2 =~
			  s/(Мелеха)([^А-Я,а-я]|$|[ -_\/,.])/Мелёха$2/gi;
			$in2 =~
			  s/(Мелеша)([^А-Я,а-я]|$|[ -_\/,.])/Мелёша$2/gi;
			$in2 =~
			  s/(Надена)([^А-Я,а-я]|$|[ -_\/,.])/Надёна$2/gi;
			$in2 =~
			  s/(Надеха)([^А-Я,а-я]|$|[ -_\/,.])/Надёха$2/gi;
			$in2 =~
s/(Настена)([^А-Я,а-я]|$|[ -_\/,.])/Настёна$2/gi;
			$in2 =~
s/(Настеха)([^А-Я,а-я]|$|[ -_\/,.])/Настёха$2/gi;
			$in2 =~ s/(Нема)([^А-Я,а-я]|$|[ -_\/,.])/Нёма$2/gi;
			$in2 =~
s/(Нефедка)([^А-Я,а-я]|$|[ -_\/,.])/Нефёдка$2/gi;
...
s/(Парменка)([^А-Я,а-я]|$|[ -_\/,.])/Пармёнка$2/gi;
			$in2 =~
s/(Пармеха)([^А-Я,а-я]|$|[ -_\/,.])/Пармёха$2/gi;
			$in2 =~
s/(Пармеша)([^А-Я,а-я]|$|[ -_\/,.])/Пармёша$2/gi;
			$in2 =~
s/(Парфенка)([^А-Я,а-я]|$|[ -_\/,.])/Парфёнка$2/gi;
			$in2 =~
s/(Парфеха)([^А-Я,а-я]|$|[ -_\/,.])/Парфёха$2/gi;
			$in2 =~
			  s/(Петеха)([^А-Я,а-я]|$|[ -_\/,.])/Петёха$2/gi;
			$in2 =~
			  s/(Петеша)([^А-Я,а-я]|$|[ -_\/,.])/Петёша$2/gi;
			$in2 =~
s/(Селиверстка)([^А-Я,а-я]|$|[ -_\/,.])/Селивёрстка$2/gi;
			$in2 =~ s/(Сема)([^А-Я,а-я]|$|[ -_\/,.])/Сёма$2/gi;
			$in2 =~
s/(Семенка)([^А-Я,а-я]|$|[ -_\/,.])/Семёнка$2/gi;
			$in2 =~
			  s/(Сережа)([^А-Я,а-я]|$|[ -_\/,.])/Серёжа$2/gi;
			$in2 =~
			  s/(Сереня)([^А-Я,а-я]|$|[ -_\/,.])/Серёня$2/gi;
			$in2 =~
s/(Сильверстка)([^А-Я,а-я]|$|[ -_\/,.])/Сильвёрстка$2/gi;
			$in2 =~ s/(Степа)([^А-Я,а-я]|$|[ -_\/,.])/Стёпа$2/gi;
			$in2 =~ s/(Тена)([^А-Я,а-я]|$|[ -_\/,.])/Тёна$2/gi;
			$in2 =~
			  s/(Тереня)([^А-Я,а-я]|$|[ -_\/,.])/Терёня$2/gi;
			$in2 =~
			  s/(Тереха)([^А-Я,а-я]|$|[ -_\/,.])/Терёха$2/gi;
			$in2 =~
			  s/(Тереша)([^А-Я,а-я]|$|[ -_\/,.])/Терёша$2/gi;
			$in2 =~ s/(Теша)([^А-Я,а-я]|$|[ -_\/,.])/Тёша$2/gi;
			$in2 =~
s/(Федорка)([^А-Я,а-я]|$|[ -_\/,.])/Фёдорка$2/gi;
			$in2 =~
s/(Феклушка)([^А-Я,а-я]|$|[ -_\/,.])/Фёклушка$2/gi;
			$in2 =~
s/(Фефелка)([^А-Я,а-я]|$|[ -_\/,.])/Фефёлка$2/gi;
			$in2 =~
			  s/(Фленка)([^А-Я,а-я]|$|[ -_\/,.])/Флёнка$2/gi;
			$in2 =~
s/(Христена)([^А-Я,а-я]|$|[ -_\/,.])/Христёна$2/gi;
			$in2 =~
s/(Христеня)([^А-Я,а-я]|$|[ -_\/,.])/Христёня$2/gi;
			$in2 =~
			  s/(Шурена)([^А-Я,а-я]|$|[ -_\/,.])/Шурёна$2/gi;
			##NEW - mre
			##Added 20160603 MRE
			...
			$in2 =~
s/(^|[ -\/])Чернышев($|[-\/,. ]|[аеоыу])/$1Чернышёв$2/gi;

#Евгеневич
#$in2 =~ s/(^|[ -_\/])(Анатол|Аркад|Арсен|Артем|Васил|Валер|Витал|Геннад|Георг|Григор|Евген|Юр)(ев|иев)/$1$2ьев/g; ##MRE 20160503
			$in2 =~
s/(Анатол|Аркад|Арсен|Артем|Васил|Валер|Витал|Геннад|Григор|Евген|Юр)ев/$1йев/g
			  ;    ##MRE 20160503 201600603 Георг| verwijderd
			$in2 =~
s/(Анатол|Аркад|Арсен|Артем|Васил|Валер|Витал|Геннад|Григор|Евген|Юр)иев/$1йев/g
			  ;    ##MRE 20160503 201600603 Георг| verwijderd
...
#$in2 =~ s/(^|[ -\/])//gi;
			...
			$in2 =~
s/([А-Я,a-я])(в)(ев|ева|еве|еву|евым|евых|евыми|евой)($|[-\/,. ])/$1$2ь$3$4/gi;
...
##2nd Testset ENGLISH INPUT
		...
		$nlpop =~
s/Natalja_Aleksejevna_Narotsjnitskaja/Natalia_Aleksejevna_Narotsjnitskaja/;
...
##ENG
  ...
  #Nataliya_Alekseyevna_Narochnitskaya >< Nataliya_Alekseevna_Narochnitskaya [-]
		...
		$germanpop =~ s/kS|ks/x/g;
		$germanpop =~ s/([aeiouy])s([aeiouy])/$1ss$2/gi
		  if ( $namerus !~ /[аеёиоуыэюя]з[аеёиоуыэюя]/ )
		  ;    ##HERE
		...
		push @output,
		  $generator->addOutput( 'ALA-LC',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'ALA-LC-simpel',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'wetenschappelijk',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'BGN-PCGN',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'BGN-PCGN-simpel',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'british-standard',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'GOST-1983',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'GOST-2000b',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'GOST-2004',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'GOST_R_52535.1-2006',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'ICAO',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'ISO9-1995',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'paspoort-1997-2010',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'paspoort-ussr',
			'<span class="na_field">Not applicable</span>' );
		push @output,
		  $generator->addOutput( 'rijbewijs',
			'<span class="na_field">Not applicable</span>' );
...
##NU
	...
	$germanpop =~ s/kS|ks/x/g;
	$germanpop =~ s/([aeiouy])s([aeiouy])/$1ss$2/gi
	  if ( $name !~ /[аеёиоуыэюя]з[аеёиоуыэюя]/ );   ##HERE
	$germanpop =~ s/Wasili/Wassili/;                   ##Waarom nodig?
	$germanpop =~ s/(ss)(ibir)/s$2/gi;
	$germanpop =~ s/(nowo)(ss)([aeiouy])/$1s$3/gi;
	$germanpop =~ s/(lesso)(ss)([aeiouy])/$1s$3/gi;
